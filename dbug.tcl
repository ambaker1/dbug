...
namespace eval ::dbug {
    ...
    # Exported commands
	namespace export >; # Simply print command and result, similar to in interactive mode.
...
proc ::dbug::debug {script {depth 0}} {
    variable baseLevel
    variable maxDepth
    variable cmd
    # Check input
...
proc ::dbug::Debug {cmd} {uplevel 2 $cmd}

# EnterStep --
# 
# Private procedure to print out intermediate steps

proc ::dbug::EnterStep {cmdString args} {
    variable baseLevel
    variable maxDepth
    variable cmd
...
proc ::dbug::LeaveStep {cmdString code result args} {
    variable baseLevel
    variable maxDepth
    variable cmd
    set depth [expr {[info level] - $baseLevel}]
...
trace add execution ::dbug::Debug enterstep ::dbug::EnterStep
trace add execution ::dbug::Debug leavestep ::dbug::LeaveStep
...
proc ::dbug::assert {value {op ==} {expected true}} {
